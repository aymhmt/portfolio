...
export function CertificateCard({
	...
	return (
		<Link
			...
			ref={ref}
			className={cn(
				"group relative h-46 w-full cursor-pointer overflow-hidden border-zinc-900 dark:border-zinc-800 transition-all duration-500 hover:ring-3 ring-zinc-900/5 dark:ring-zinc-800",
		...
		>
			...
			>
				<div className="flex flex-col text-base transition-transform duration-500">
